<%-- community/talent/list.jsp — community/index.jsp 에서 include --%>
<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
<%@ taglib prefix="c" uri="jakarta.tags.core" %>
<c:set var="contextPath" value="${pageContext.request.contextPath}" />
<c:set var="pageId"      value="community" />
<c:set var="commTab"     value="talent" />
...
<style>
    ...
    <div class="talent-list">
        <%-- 재능나눔 카드 1 — 애견미용 (사업자) --%>
        <div class="talent-card" onclick="location.href='${contextPath}/community/talent/detail?id=1'">
            ...
            <div class="talent-right">
                ...
                <button class="talent-apply-btn" onclick="event.stopPropagation();location.href='${contextPath}/community/talent/detail?id=1'">상세보기</button>
            </div>
        </div>

        <%-- 재능나눔 카드 2 — 무료 진료 (사업자) --%>
        <div class="talent-card" onclick="location.href='${contextPath}/community/talent/detail?id=2'">
            ...
            <div class="talent-right">
                ...
                <button class="talent-apply-btn" onclick="event.stopPropagation();location.href='${contextPath}/community/talent/detail?id=2'">상세보기</button>
            </div>
        </div>

        <%-- 재능나눔 카드 3 — 사진 촬영 (일반 사용자) --%>
        <div class="talent-card" onclick="location.href='${contextPath}/community/talent/detail?id=3'">
            ...
            <div class="talent-right">
                ...
                <button class="talent-apply-btn" onclick="event.stopPropagation();location.href='${contextPath}/community/talent/detail?id=3'">상세보기</button>
            </div>
        </div>

        <%-- 재능나눔 카드 4 — 운송 --%>
        <div class="talent-card" onclick="location.href='${contextPath}/community/talent/detail?id=4'">
            ...
            <div class="talent-right">
                ...
                <button class="talent-apply-btn" onclick="event.stopPropagation();location.href='${contextPath}/community/talent/detail?id=4'">상세보기</button>
            </div>
        </div>

        <%-- 재능나눔 카드 5 — 사진 촬영 (사업자 사진관) --%>
        <div class="talent-card" onclick="location.href='${contextPath}/community/talent/detail?id=5'">
            ...
            <div class="talent-right">
                ...
                <button class="talent-apply-btn" onclick="event.stopPropagation();location.href='${contextPath}/community/talent/detail?id=5'">상세보기</button>
            </div>
        </div>
