...
<div class="sd-wrap">
  <div>
    ...
    <div class="sd-tags">
      <span class="sd-tag">대형견 가능</span>
      <span class="sd-tag">풀빌라</span>
      <span class="sd-tag">독채</span>
      <span class="sd-tag">취사 가능</span>
      <span class="sd-tag">바베큐</span>
      <span class="sd-tag">무료 주차</span>
    </div>
  ...
  <div class="reserve-card">
    ...
    <div class="rc-form-group">
      <label>반려동물</label>
      <select><option>몽이 (골든 리트리버)</option><option>몽이+나비 (2마리)</option><option>직접 입력</option></select>
    </div>
    ...
    <div class="rc-price-row"><span>청소비</span><span>30,000원</span></div>
    <div class="rc-price-row total"><span>총 결제금액</span><span>188,000원</span></div>
    <button class="btn-reserve-big" onclick="location.href='${contextPath}/stay/reserve?id=1'">예약 신청하기</button>
