    ...
    <div class="info-wrap">
        ...
        <div class="info-hero">
            <div class="info-hero-icon">
                <svg viewBox="0 0 24 24"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><line x1="9" y1="22" x2="9" y2="12"/><line x1="15" y1="22" x2="15" y2="12"/></svg>
            </div>
            <div>
                <h2>병원 정보 관리</h2>
        ...
        <!-- ===================================
             ...
             =================================== -->
        <form name="hospitalInfoForm" method="post"
              action="${contextPath}/biz/hospital/info"
            ...
            -->
            <input type="hidden" name="hoursJson" id="hoursJsonInput"
                   value='${hospital.hoursJson}'>
            ...
            <div class="info-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-group">
                        ...
                        <input type="tel" name="phone" value="${hospital.phone}"
                    ...
                    <div class="info-group full">
                        ...
                        <div class="info-input-row">
                            <input type="text" name="addr" value="${hospital.addr}"
                                   placeholder="주소 검색을 클릭하세요" readonly>
                            <button type="button" class="btn-addr" id="btnAddr">주소 검색</button>
                        </div>
                        <input type="text" name="addrDetail" value="${hospital.addrDetail}"
                               placeholder="상세 주소 (층, 호수 등)" style="margin-top:8px">
                    </div>

                    <div class="info-group full">
                        <label>병원 소개</label>
                        <textarea name="description"
                                  placeholder="병원을 소개하는 문구를 입력하세요.">${hospital.description}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="info-section">
                ...
                <table class="hours-table">
                    <thead>
                        <tr><th>요일</th><th>영업</th><th>진료시간</th><th>점심시간</th></tr>
                    </thead>
                    <tbody>
                        <!--
                            각 행의 id 규칙:  row-요일명  (예: row-월, row-토)
                            각 input id 규칙: open-요일명, close-요일명, lunchS-요일명, lunchE-요일명
                            → JS에서 getElementById로 값을 읽고 쓸 때 사용
                        -->
                        ...
                        <tr id="row-금">
                            ...
                            <td><div class="hours-time"><input type="time" id="lunchS-금" value="12:00"><span>~</span><input type="time" id="lunchE-금" value="13:00"></div></td>
                        </tr>
                        ...
                        <tr id="row-토">
                            ...
                            <td><div class="hours-time"><input type="time" id="lunchS-토" value=""><span>~</span><input type="time" id="lunchE-토" value=""></div></td>
                        </tr>
                        ...
                        <tr id="row-공휴일" class="row-off">
                            ...
                            <td><div class="hours-time"><input type="time" id="lunchS-공휴일" value=""><span>~</span><input type="time" id="lunchE-공휴일" value=""></div></td>
                        </tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="info-section">
                ...
                <div class="img-upload-area">
                    ...
                    <c:forEach var="img" items="${imgList}" varStatus="st">
                        <div class="img-upload-box ${st.index == 0 ? 'main' : ''}"
                             id="existing-${img.fileId}">
                            <!-- 이미 저장된 이미지 표시 -->
                            <img class="img-preview"
                                 src="${contextPath}/upload/${img.fileUrl}">
            ...
            <div class="info-btn-row">
                <button type="button" class="btn-info-cancel"
                        onclick="location.href='${contextPath}/biz/hospital'">취소</button>
