...
<style>
  ...
  /* 지도 영역 */
  .st-map-area{background:var(--bg-page);border:1px solid var(--border);border-radius:var(--radius-md);height:280px;display:flex;align-items:center;justify-content:center;margin-bottom:14px;overflow:hidden}
  .st-map-area img{width:100%;height:100%;object-fit:cover;border-radius:var(--radius-md)}
